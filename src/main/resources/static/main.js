...
var AppointmentCreateComponent = /** @class */ (function () {
    ...
    AppointmentCreateComponent.prototype.searchAppointment = function (doctorName, appointmentDate, hourslot) {
        ...
        this.appointmentSearchService.getAllAppointments(doctorName.doctorName, appointmentDate)
            .subscribe(function (data) {
            console.log(data);
            _this.appointmentSearched = true;
            if (data == null) {
                _this.error = _this.DATANOTFOUND;
            }
            else {
                ...
                if (data.length > 0) {
                    ...
                    var hoursSlotFiltered = _this.hoursSlot1.filter(function (o1) { return !data.some(function (o2) { return appointmentDate + " " + o1 === o2.startTime; }); });
