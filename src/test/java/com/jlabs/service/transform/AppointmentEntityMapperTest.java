...
//   final String appointmentDate1 = String.valueOf(appointmentDateConverted.getDayOfYear()).concat("-").concat(
//     String.valueOf(appointmentDateConverted.getDayOfMonth()).concat("-").concat(
//       String.valueOf(appointmentDateConverted.getDayOfWeek())));
//   final LocalDate localDate = appointmentDateConverted.toLocalDateTime().toLocalDate();
//   final LocalTime localTime = appointmentDateConverted.toLocalDateTime().toLocalTime();
//
//   log.info(appointmentDateConverted.toString());
//
//
